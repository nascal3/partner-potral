		...
		<v-card flat class="ma-0 pa-0">
			...
			<v-dialog transition="dialog-top-transition" max-width="600">
				<template v-slot:activator="{ on, attrs }">
					<v-card
						v-if="expirationNotification === 1"
						width="500"
						class="d-flex justify-center align-center px-8 py-2">
						<div class="d-flex align-center">
							<v-icon color="success">mdi-alert-circle</v-icon>
							<v-card-text>
								<p class="body-1">Expiring Document</p>
								<p>Upload by: 12 Decemeber 2022</p>
							</v-card-text>
						</div>
				...
				<template v-slot:default="dialog">
					<v-card width="800" class="pa-8">
						<div class="d-flex align-center">
							<v-icon color="success" class="pr-4">mdi-alert-circle</v-icon>
							<v-card-title class="text-h5 pa-0"
								>Expiring Document</v-card-title
							>
						</div>
						<v-card-text>
							<p class="body-1 black--text">John Doe</p>
							<p class="body-1 black--text">
								The following documents will be expiring soon:
							</p>
							<div class="d-flex align-center py-2">
								<v-icon color="success" large class="pr-5"
									>mdi-check-circle-outline</v-icon
								>
								<div class="pb-2">
									<p class="text-h6 black--text ma-0">Driver's licencse</p>
									<p class="body-2 black--text ma-0">
										Expiry: 12th December 2022
									</p>
								</div>
							</div>
							<p class="body-1 black--text">
								Please renew them and submit before 12th December 2022 otherwise
								you will not be able to service Sendy orders.
							</p>
						</v-card-text>
			...
			<v-card width="800" class="pa-8">
				<div class="d-flex align-center">
					<v-icon color="success" class="pr-4">mdi-alert-circle</v-icon>
					<v-card-title class="text-h5 pa-0">Expiring Document</v-card-title>
				</div>
				<v-card-text>
					<p class="body-1 black--text">John Doe</p>
					<p class="body-1 black--text">
					...
					<div class="d-flex align-center py-2">
						...
						<div class="pb-2">
							<p class="text-h6 black--text ma-0">Driver's licencse</p>
							<p class="body-2 black--text ma-0">Expiry: 12th December 2022</p>
						</div>
					</div>
					<p class="body-1 black--text">
						Please renew them and submit before 12th December 2022 otherwise you
			...
			<v-card-text class="px-0">
				<v-tabs v-model="tab" id="orders-tabs" color="#324BA8" left>
